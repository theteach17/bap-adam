...
function pcReadPrecheckConfigFromSettingsSheet_() {
  ...
  var allowed = [
    ...
    /* [ASSISTANT PATCH] คีย์ของโมดูลผู้ช่วย เพิ่มต่อท้ายเท่านั้น ไม่แก้ตรรกะเดิม */
    'PC_ASSIST_ENABLED','PC_ASSIST_PILOT_EMAILS','PC_ASSIST_STATUS_SCOPE','PC_ASSIST_NAME_MATCH',
    'PC_ASSIST_CONTACT_TEXT','PC_ASSIST_RATE_PER_MIN','PC_ASSIST_LOG_RETENTION_DAYS','PC_ASSIST_WORKLOAD_FROM_YEAR'
  ];
  var config = {};
